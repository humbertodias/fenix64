...
#define MN_ADD		(0x23| MN_0_PARAMS)
#define MN_SUB		(0x24| MN_0_PARAMS)
#define MN_MOD		(0x25| MN_0_PARAMS)
#define MN_ROR		(0x26| MN_0_PARAMS)
#define MN_ROL		(0x27| MN_0_PARAMS)
#define MN_AND		(0x28| MN_0_PARAMS)
#define MN_OR		(0x29| MN_0_PARAMS)
#define MN_XOR		(0x2A| MN_0_PARAMS)

/* Comparaciones binarias */

#define MN_EQ		(0x2B| MN_0_PARAMS)
#define MN_NE		(0x2C| MN_0_PARAMS)
#define MN_GT		(0x2D| MN_0_PARAMS)
#define MN_LT		(0x2E| MN_0_PARAMS)
#define MN_GTE		(0x2F| MN_0_PARAMS)
#define MN_LTE		(0x30| MN_0_PARAMS)

/* Post/pre-operadores */

#define MN_POSTINC	(0x31| MN_1_PARAMS)
#define MN_POSTDEC	(0x32| MN_1_PARAMS)
...
#define MN_VARSUB	(0x37| MN_0_PARAMS)
#define MN_VARMUL	(0x38| MN_0_PARAMS)
#define MN_VARDIV	(0x39| MN_0_PARAMS)
#define MN_VARMOD	(0x3A| MN_0_PARAMS)
#define MN_VARXOR	(0x3B| MN_0_PARAMS)
#define MN_VARAND	(0x3C| MN_0_PARAMS)
#define MN_VAROR	(0x3D| MN_0_PARAMS)
#define MN_VARROR	(0x3E| MN_0_PARAMS)
#define MN_VARROL	(0x3F| MN_0_PARAMS)

/* Funciones de cadena */

#define MN_SUBSTR       (0x40| MN_0_PARAMS)
#define MN_CHRSTR       (0x41| MN_0_PARAMS)
#define MN_INT2STR      (0x42| MN_1_PARAMS)
#define MN_FLOAT2STR    (0x43| MN_1_PARAMS)
#define MN_CHR2STR      (0x44| MN_1_PARAMS)
