#ifndef __SYSPROCS_V1_H
#define __SYSPROCS_V1_H

/* System procs as compiled by Fenix 0.84 (DCB version 0x0100). */
...
SYSPROC sysprocs_v1[] =
{
    ...
    { 0xB6, "PLAY_CD"               , "II"    , TYPE_DWORD  , 2 , SYSMACRO(fxi_play_cd_084) },
    { 0xB7, "STOP_CD"               , ""      , TYPE_DWORD  , 0 , SYSMACRO(fxi_stop_cd_084) },
    { 0xB8, "IS_PLAYING_CD"         , ""      , TYPE_DWORD  , 0 , SYSMACRO(fxi_is_playing_cd_084) },
